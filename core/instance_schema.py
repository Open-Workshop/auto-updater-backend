...
SYNC_FIELD_SPECS: tuple[SyncFieldSpec, ...] = (
    SyncFieldSpec("apiBase", "OW_API_BASE", "api_base", None, "API base", "str", "https://api.openworkshop.miskler.ru"),
    SyncFieldSpec("pageSize", "OW_PAGE_SIZE", "page_size", None, "Page size", "int", 50),
    ...
    SyncFieldSpec("logSteamRequests", "OW_LOG_STEAM_REQUESTS", "log_steam_requests", None, "Log Steam requests", "bool", False),
    ...
    SyncFieldSpec("steamMaxPages", "OW_STEAM_MAX_PAGES", "steam_max_pages", None, "Steam max pages", "int", 1000),
    SyncFieldSpec("steamStartPage", "OW_STEAM_START_PAGE", "steam_start_page", None, "Steam start page", "int", 1),
    SyncFieldSpec("steamMaxItems", "OW_STEAM_MAX_ITEMS", "steam_max_items", None, "Steam max items", "int", 0),
    SyncFieldSpec("steamDelay", "OW_STEAM_DELAY", "steam_delay", None, "Steam page delay", "float", 1.0, minimum=0.0),
    ...
    SyncFieldSpec("forceRequiredItemId", "OW_FORCE_REQUIRED_ITEM_ID", "force_required_item_id", None, "Forced required item", "str", ""),
    SyncFieldSpec("publicMode", "OW_MOD_PUBLIC", "public_mode", None, "Mod public mode", "int", 0),
    SyncFieldSpec("withoutAuthor", "OW_WITHOUT_AUTHOR", "without_author", None, "Without author", "bool", False),
