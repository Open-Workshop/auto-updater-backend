...
from kube.mirror_instance import common_labels, instance_name, normalize_instance
from ui.ui_formatting import _int_value, _parse_bytes, _sum_values
from ui.ui_kube_utils import _pod_snapshot, _pod_usage_metrics, _read_node_stats_summary, _select_best_pod
...
def _pod_disk_usage(
    ...
    """Get disk usage for pods from node stats summary."""
